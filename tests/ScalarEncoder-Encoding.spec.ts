...
@Test(`encoding 0-1 with min=0, max=1, w=2 and precision=0.1 must result in
    ...
    0.3 - 00000110000000000000
          00000011000000000000
    0.4 - 00000001100000000000
          00000000110000000000
    0.5 - 00000000011000000000
          00000000001100000000
    0.6 - 00000000000110000000
          00000000000011000000
    0.7 - 00000000000001100000
          00000000000000110000
    0.8 - 00000000000000011000
          00000000000000001100
    0.9 - 00000000000000000110
    ...
    w=3, p=0.2, n=15, nb=15
    0.00 - 100000000000011
           110000000000001
           111000000000000
    0.20 - 011100000000000
           001110000000000
           000111000000000
    0.40 - 000011100000000
           000001110000000
           000000111000000
    0.60 - 000000011100000
           000000001110000
           000000000111000
    0.80 - 000000000011100
           000000000001110
           000000000000111
    1.00 - 100000000000011
    ...
    public test_get_n_for_w_2_range_0_to_1_for_precision_0_dot_1_rotative() {
        ...
        Expect(ScalarEncoderBuilder.build(expectedN2, 2, min, max, rotative).buckets.length)
        .toBe(8);

        const n4 = ScalarEncoder.getNforPrecision(0.2, 2, min, max, rotative);
        const expectedN4 = "1000000001".length;
        Expect(ScalarEncoderBuilder.build(expectedN4, 2, min, max, rotative).buckets.length)
        .toBe(10);

        const n = ScalarEncoder.getNforPrecision(precision, w, min, max, rotative);
        const expectedN = "10000000000000000001".length;
        Expect(ScalarEncoderBuilder.build(expectedN, 2, min, max, rotative).buckets.length)
        .toBe(20);

        const n3 = ScalarEncoder.getNforPrecision(0.25, 3, min, max, rotative);
        const expectedN3 = "100000000011".length;
        Expect(ScalarEncoderBuilder.build(expectedN3, 2, min, max, rotative).buckets.length)
        .toBe(12);

        const n5 = ScalarEncoder.getNforPrecision(0.2, 3, min, max, rotative);
        const expectedN5 = "100000000000011".length;
        Expect(ScalarEncoderBuilder.build(expectedN5, 2, min, max, rotative).buckets.length)
        .toBe(15);

        Expect([n2, n4, n, n3, n5]).toEqual([expectedN2, expectedN4, expectedN, expectedN3, expectedN5]);
